...
namespace PeluqueriaDesktop
{
    public partial class FrmParametros : Form
    {
        ...
        private void CargarDatosEnPantalla()
        {
            ...
            {
                PbxImagen.Image = HelperPeluqueria.RecuperarImagenDeArchivoDeRecursos("fondoSistema");
        ...
        private void btnGuardarModificar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Properties.Settings.Default.imagenDeFondo != "")
                {
                    HelperPeluqueria.AlmacenarImagenEnArchivoDeRecursos(Image.FromFile(Properties.Settings.Default.imagenDeFondo), "fondoSistema");
